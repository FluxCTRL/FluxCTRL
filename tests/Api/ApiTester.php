<?php //[STAMP] e29ab56768daf973c2bdab1d4724e405
...
use FluxCtrl\TestSuite\Codeception\ApiHelper;
...
class ApiTester extends Actor
{
     ...
     *
     * @return void
     * @see \Cake\Codeception\Framework::loadFixtures()
     */
     ...
     * @
     * @see \Cake\Codeception\Framework::expectedCakePHPVersion()
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::seeInConfig()
     */
     ...
     * @param mixed $value Value to check for. If `NULL`, checks only key.
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::dontSeeInConfig()
     */
     ...
     * @return void
     * @see \Cake\Codeception\Framework::cleanUpInsertedRecords()
     */
    public function cleanUpInsertedRecords($model = null, $conditions = null) {
        return $this->scenario->runStep(new \Codeception\Step\Action('cleanUpInsertedRecords', func_get_args()));
    }
     ...
     * @see \Cake\Codeception\Framework::haveRecord()
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::seeRecord()
     */
     ...
     * @param array $conditions Conditions to find the record.
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::dontSeeRecord()
     */
     ...
     * @see \Cake\Codeception\Framework::grabRecord()
     */
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::seeAssociation()
     */
    public function canSeeAssociation($table, $name, $type = null, $options = null) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('seeAssociation', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Cake\Codeception\Framework::seeAssociation()
     */
    public function seeAssociation($table, $name, $type = null, $options = null) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('seeAssociation', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::dontSeeAssociation()
     */
    public function cantSeeAssociation($table, $name, $type = null, $options = null) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeAssociation', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Cake\Codeception\Framework::dontSeeAssociation()
     */
    public function dontSeeAssociation($table, $name, $type = null, $options = null) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('dontSeeAssociation', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::seeValidationErrors()
     */
    public function canSeeValidationErrors($entity, $data, $expectedErrors = null) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('seeValidationErrors', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
     ...
     * @see \Cake\Codeception\Framework::seeValidationErrors()
     */
    public function seeValidationErrors($entity, $data, $expectedErrors = null) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('seeValidationErrors', func_get_args()));
    }
     ...
     *
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Cake\Codeception\Framework::dontSeeValidationErrors()
     */
    public function cantSeeValidationErrors($entity, $data) {
        return $this->scenario->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeValidationErrors', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function dontSeeValidationErrors($entity, $data) {
        return $this->scenario->runStep(new \Codeception\Step\Assertion('dontSeeValidationErrors', func_get_args()));
    }
     ...
     *
     *
     * @see \Cake\Codeception\Framework::grabTable()
     */
    public function grabTable($alias) {
        return $this->scenario->runStep(new \Codeception\Step\Action('grabTable', func_get_args()));
    }
     ...
     *
     *
     * @see \Cake\Codeception\Framework::tryPatching()
     */
    public function tryPatching($entity, $data) {
        return $this->scenario->runStep(new \Codeception\Step\Action('tryPatching', func_get_args()));
    }
     ...
     *
     *
     * @see \Cake\Codeception\Framework::tryValidating()
     */
    public function tryValidating($entity, $data) {
        return $this->scenario->runStep(new \Codeception\Step\Action('tryValidating', func_get_args()));
    }
